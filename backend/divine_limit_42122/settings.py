"""
Django settings for divine_limit_42122 project.
...
ROOT_URLCONF = 'divine_limit_42122.urls'
...
WSGI_APPLICATION = 'divine_limit_42122.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "divine_limit_42122 API",
    "DESCRIPTION": "API documentation for divine_limit_42122 App",
    "VERSION": "v1",
}
